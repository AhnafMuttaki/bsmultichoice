 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_bsmultichoice_renderer_base extends qtype_with_combined_feedback_renderer {
    ...
    public function formulation_and_controls(question_attempt $qa,
        ...
        $this->page->requires->js_call_amd('qtype_bsmultichoice/answers', 'init',
     ...
     * options returned by {@link qtype_bsmultichoice:;get_numbering_styles()}.
    ...
    protected function correct_choices(array $right) {
        ...
        if (count($right) == 1) {
                return get_string('correctansweris', 'qtype_bsmultichoice',
                        implode(', ', $right));
        } else if (count($right) > 1) {
                return get_string('correctanswersare', 'qtype_bsmultichoice',
                        implode(', ', $right));
        } else {
                return "";
        }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_bsmultichoice_single_renderer extends qtype_bsmultichoice_renderer_base {
    ...
    protected function prompt() {
        return get_string('selectone', 'qtype_bsmultichoice');
    }
    ...
    public function after_choices(question_attempt $qa, question_display_options $options) {
        ...
        $clearchoicewrapperattrs = [
            ...
            'class' => 'qtype_bsmultichoice_clearchoice',
        ];
        ...
        $clearchoice = html_writer::link('#', get_string('clearchoice', 'qtype_bsmultichoice'),
        ...
        $this->page->requires->js_call_amd('qtype_bsmultichoice/clearchoice', 'init',
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_bsmultichoice_multi_renderer extends qtype_bsmultichoice_renderer_base {
    ...
    protected function prompt() {
        return get_string('selectmulti', 'qtype_bsmultichoice');
    }
    ...
    protected function num_parts_correct(question_attempt $qa) {
        if ($qa->get_question()->get_num_selected_choices($qa->get_last_qt_data()) >
            ...
            return get_string('toomanyselected', 'qtype_bsmultichoice');
        }
